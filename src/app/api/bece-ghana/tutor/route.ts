...
const EXAM_ID = "bece-ghana";
const EXAM_DISPLAY_NAME = "BECE Ghana (Basic Education Certificate Examination)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover all BECE subjects: English Language, Mathematics, Integrated Science, Social Studies, Religious & Moral Education, Creative Arts, French, Ghanaian Language, and Information & Communication Technology. Align to WAEC BECE syllabus.
