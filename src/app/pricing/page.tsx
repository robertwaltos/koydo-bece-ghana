...
export const metadata: Metadata = {
  title: "Pricing — Bece Ghana Premium",
  description: "Unlock unlimited Bece Ghana practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=bece-ghana&cadence=annual`;
