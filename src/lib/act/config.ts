// Auto-generated shim — re-exports from @/lib/bece-ghana/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _bece_ghana_Config } from "@/lib/bece-ghana/config";
import { EXAM_CONFIG as _raw } from "@/lib/bece-ghana/config";
